...
public class WeatherBean {
	...
	private List<FutureWeatherBean> futureLists;
	...
	public List<FutureWeatherBean> getFutureLists() {
		return futureLists;
	}

	public void setFutureLists(List<FutureWeatherBean> futureLists) {
		this.futureLists = futureLists;
	}
